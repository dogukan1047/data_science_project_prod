...
def create_csv_from_images(image_dir, output_csv, auto_labels):
...
# Örnek kullanım
image_dir = "./output"  # Parçaların bulunduğu dizin
output_csv = "./output/labels1.csv"  # Oluşturulacak CSV dosyasının adı
auto_labels = ["x", "y", "z", "t", 1, 2, 3, 4, 5, 6]  # Otomatik etiketler
auto_labels *= (len(os.listdir(image_dir)) // 10)  # Her etiketi 10 kez tekrarlayın
create_csv_from_images(image_dir, output_csv, auto_labels)
